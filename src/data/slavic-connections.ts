...
export const SLAVIC_CONNECTIONS: SlavicConnection[] = [
  ...
  },
  {
    ...
    kind: "sound-pattern",
    title: "глава ↔ głowa",
    summary: "A useful example of regular-looking sound correspondence rather than simple spelling similarity.",
    bg: "глава",
    pl: "głowa",
  ...
  },
  {
    ...
    kind: "false-friend",
    title: "гора ≠ góra",
    summary: "Familiar shape, different meaning — exactly the kind of trap Slavic learners should see early.",
    bg: "гора = forest",
    pl: "góra = mountain",
  ...
  },
  {
    ...
    summary: "Bulgarian often uses a preposition where Polish also requires a specific case ending.",
    bg: "с приятел",
    pl: "z przyjacielem",
  ...
  },
  {
    ...
    summary: "Polish case choice carries information Bulgarian usually expresses without noun-case endings.",
    bg: "нямам книга",
    pl: "nie mam książki",
