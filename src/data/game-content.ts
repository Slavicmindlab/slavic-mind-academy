...
export const GAME_SENTENCES: GameSentence[] = [
  ...
  sentence("b1-15", "B1", "study", "Zauważyłem, że łatwiej zapamiętuję słowa, kiedy używam ich w własnych zdaniach.", "Забелязах, че запомням думите по-лесно, когато ги използвам в свои изречения.", "I noticed that I remember words more easily when I use them in my own sentences."),
