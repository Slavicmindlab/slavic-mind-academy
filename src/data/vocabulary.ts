...
export const WORDS: Word[] = [
  ...
  w("ds_d1", "tak", "да", "yes", "tahk", "phrase", "—", "—", "Tak, oczywiście.", "Да, разбира се.", "Daily speech", "A1"),
  w("ds_d2", "nie", "не", "no", "nyeh", "phrase", "—", "—", "Nie, dziękuję.", "Не, благодаря.", "Daily speech", "A1"),
  w("ds_d3", "może", "може би", "maybe", "MOH-zheh", "adverb", "—", "—", "Może jutro pójdziemy.", "Може би утре ще отидем.", "Daily speech", "A1"),
  w("ds_d4", "zawsze", "винаги", "always", "ZAHV-sheh", "adverb", "—", "—", "Zawsze piję kawę rano.", "Винаги пия кафе сутрин.", "Daily speech", "A2"),
  w("ds_d5", "nigdy", "никога", "never", "NEEG-di", "adverb", "—", "—", "Nigdy nie kłamię.", "Никога не лъжа.", "Daily speech", "A2"),
  w("ds_d6", "często", "често", "often", "CHEN-stoh", "adverb", "—", "—", "Często chodzę do kina.", "Често ходя на кино.", "Daily speech", "A2"),
  w("ds_d7", "naprawdę", "наистина", "really", "nah-PRAHV-dyeh", "adverb", "—", "—", "Naprawdę mi przykro.", "Наистина съжалявам.", "Daily speech", "A2"),
  ...
  // Verbs (extra)
  w("v1b", "wstawać", "ставам", "to get up", "fstah-VAHCH", "verb", "—", "—", "Wstaję o siódmej.", "Ставам в седем.", "Verbs", "A2"),
  w("v2b", "spać", "спя", "to sleep", "spahch", "verb", "—", "—", "Śpię osiem godzin.", "Спя осем часа.", "Verbs", "A1"),
  w("v3b", "biegać", "тичам", "to run", "BYEH-gahch", "verb", "—", "—", "Biegam w parku.", "Тичам в парка.", "Verbs", "A2"),
  w("v4b", "pływać", "плувам", "to swim", "PWI-vahch", "verb", "—", "—", "Pływam w jeziorze.", "Плувам в езерото.", "Verbs", "A2"),
  w("v5b", "myśleć", "мисля", "to think", "MISH-lech", "verb", "—", "—", "Myślę o tobie.", "Мисля за теб.", "Verbs", "A2"),
  w("v6b", "śmiać się", "смея се", "to laugh", "shmyatch sheh", "verb", "—", "—", "Śmieję się głośno.", "Смея се на глас.", "Verbs", "A2"),
  w("v7b", "płakać", "плача", "to cry", "PWAH-kahch", "verb", "—", "—", "Dziecko płacze.", "Детето плаче.", "Verbs", "A2"),
  w("v8b", "śpiewać", "пея", "to sing", "SHPYE-vahch", "verb", "—", "—", "Śpiewam w chórze.", "Пея в хор.", "Verbs", "A2"),
  w("v9b", "tańczyć", "танцувам", "to dance", "TAHN-chich", "verb", "—", "—", "Tańczymy razem.", "Танцуваме заедно.", "Verbs", "A2"),
  w("v10b", "podróżować", "пътувам", "to travel", "poh-droo-ZHOH-vahch", "verb", "—", "—", "Lubię podróżować.", "Обичам да пътувам.", "Verbs", "A2"),

  // Time
  w("t1b", "dzisiaj", "днес", "today", "JEE-shahy", "adverb", "—", "—", "Dzisiaj jest piątek.", "Днес е петък.", "Time", "A1"),
  w("t2b", "jutro", "утре", "tomorrow", "YOO-troh", "adverb", "—", "—", "Jutro mam egzamin.", "Утре имам изпит.", "Time", "A1"),
  w("t3b", "wczoraj", "вчера", "yesterday", "FCHOH-rahy", "adverb", "—", "—", "Wczoraj padał deszcz.", "Вчера валеше дъжд.", "Time", "A1"),
  w("t4b", "tydzień", "седмица", "week", "TI-djeny", "noun", "m", "tygodnie", "Cały tydzień pracuję.", "Цяла седмица работя.", "Time", "A2"),
  w("t5b", "miesiąc", "месец", "month", "MYEH-shonts", "noun", "m", "miesiące", "Polski miesiąc.", "Полски месец.", "Time", "A2"),
  w("t6b", "rok", "година", "year", "rohk", "noun", "m", "lata", "Mam dwadzieścia lat.", "На двадесет години съм.", "Time", "A1"),
  ...
  // ============================================================
  w("trn1", "samochód", "кола", "car", "sah-MOH-khoot", "noun", "m", "samochody", "Mój samochód jest czerwony.", "Колата ми е червена.", "Transportation", "A1"),
  w("trn2", "autobus", "автобус", "bus", "ow-TOH-boos", "noun", "m", "autobusy", "Jadę autobusem do pracy.", "Пътувам с автобус до работа.", "Transportation", "A1"),
  w("trn3", "tramwaj", "трамвай", "tram", "TRAHM-vai", "noun", "m", "tramwaje", "Wsiadłem do tramwaju numer 4.", "Качих се на трамвай номер 4.", "Transportation", "A1"),
  w("trn4", "pociąg", "влак", "train", "POH-chonk", "noun", "m", "pociągi", "Pociąg odjeżdża o piątej.", "Влакът тръгва в пет.", "Transportation", "A1"),
  w("trn5", "rower", "велосипед", "bicycle", "ROH-ver", "noun", "m", "rowery", "Jeżdżę na rowerze do szkoły.", "Карам велосипед до училище.", "Transportation", "A1"),
  w("trn6", "metro", "метро", "subway", "MEH-tro", "noun", "n", "—", "Warszawskie metro jest szybkie.", "Варшавското метро е бързо.", "Transportation", "A1"),
  w("trn7", "lotnisko", "летище", "airport", "lot-NEES-ko", "noun", "n", "lotniska", "Lotnisko Chopina w Warszawie.", "Летище Шопен във Варшава.", "Transportation", "A1"),
  w("trn8", "stacja", "гара / станция", "station", "STAH-tsyah", "noun", "f", "stacje", "Następna stacja: Centrum.", "Следваща станция: Център.", "Transportation", "A1"),
  w("trn9", "bilet", "билет", "ticket", "BEE-let", "noun", "m", "bilety", "Kupiłem bilet w kasie.", "Купих билет на касата.", "Transportation", "A1"),
  w("trn10", "kierowca", "шофьор", "driver", "kyeh-ROV-tsah", "noun", "m", "kierowcy", "Kierowca jest bardzo uprzejmy.", "Шофьорът е много учтив.", "Transportation", "A1"),
  w("trn11", "samolot", "самолет", "airplane", "sah-MOH-lot", "noun", "m", "samoloty", "Samolot ląduje o trzeciej.", "Самолетът каца в три.", "Transportation", "A1"),
  w("trn12", "taksówka", "такси", "taxi", "tak-SOOV-kah", "noun", "f", "taksówki", "Zamówiłem taksówkę.", "Поръчах такси.", "Transportation", "A1"),
  w("trn13", "statek", "кораб", "ship", "STAH-tek", "noun", "m", "statki", "Statek wypływa o świcie.", "Корабът отплава призори.", "Transportation", "A2"),
  w("trn14", "motocykl", "мотоциклет", "motorcycle", "moh-TOH-tsikl", "noun", "m", "motocykle", "Ma czarny motocykl.", "Има черен мотоциклет.", "Transportation", "A2"),
  w("trn15", "przystanek", "спирка", "stop (bus/tram)", "pshi-STAH-nek", "noun", "m", "przystanki", "Czekam na przystanku.", "Чакам на спирката.", "Transportation", "A1"),
  w("trn16", "dworzec", "гара", "train station", "DVOH-zhets", "noun", "m", "dworce", "Dworzec Centralny.", "Централна гара.", "Transportation", "A1"),
  w("trn17", "peron", "перон", "platform", "PEH-ron", "noun", "m", "perony", "Pociąg odjeżdża z peronu drugiego.", "Влакът тръгва от втори перон.", "Transportation", "A2"),
  w("trn18", "rozkład jazdy", "разписание", "timetable", "ROZ-kwat YAHZ-di", "noun", "m", "—", "Sprawdź rozkład jazdy.", "Провери разписанието.", "Transportation", "A2"),
  w("trn19", "opóźnienie", "закъснение", "delay", "oh-poozh-NYEH-nyeh", "noun", "n", "opóźnienia", "Pociąg ma opóźnienie.", "Влакът има закъснение.", "Transportation", "A2"),
  w("trn20", "podróż", "пътуване", "trip", "POH-droozh", "noun", "f", "podróże", "Lubię długie podróże.", "Харесвам дълги пътувания.", "Transportation", "A1"),
  w("trn21", "autostrada", "магистрала", "highway", "ow-toh-STRAH-dah", "noun", "f", "autostrady", "Jedziemy autostradą A4.", "Караме по магистрала A4.", "Transportation", "A2"),
  w("trn22", "skrzyżowanie", "кръстовище", "intersection", "skshi-zho-VAH-nyeh", "noun", "n", "skrzyżowania", "Skręć w prawo na skrzyżowaniu.", "Завий надясно на кръстовището.", "Transportation", "B1"),
  w("trn23", "parking", "паркинг", "parking", "PAR-keenk", "noun", "m", "parkingi", "Gdzie jest parking?", "Къде е паркингът?", "Transportation", "A1"),
  w("trn24", "benzyna", "бензин", "gasoline", "ben-ZI-nah", "noun", "f", "—", "Muszę zatankować benzynę.", "Трябва да заредя бензин.", "Transportation", "A2"),
  ...
  // CLOTHING — expansion
  // ============================================================
  w("clo1", "koszula", "риза", "shirt", "ko-SHOO-lah", "noun", "f", "koszule", "Noszę białą koszulę.", "Нося бяла риза.", "Clothing", "A1"),
  w("clo2", "spodnie", "панталони", "trousers", "SPOD-nyeh", "noun", "—", "—", "Te spodnie są za długie.", "Тези панталони са твърде дълги.", "Clothing", "A1"),
  w("clo3", "sukienka", "рокля", "dress", "soo-KYEN-kah", "noun", "f", "sukienki", "Kupiła nową sukienkę.", "Купи нова рокля.", "Clothing", "A1"),
  w("clo4", "buty", "обувки", "shoes", "BOO-ti", "noun", "—", "—", "Moje buty są wygodne.", "Обувките ми са удобни.", "Clothing", "A1"),
  w("clo5", "kurtka", "яке", "jacket", "KOORT-kah", "noun", "f", "kurtki", "Włóż kurtkę, jest zimno.", "Сложи си якето, студено е.", "Clothing", "A1"),
  w("clo6", "płaszcz", "палто", "coat", "pwashch", "noun", "m", "płaszcze", "Mój płaszcz jest czarny.", "Палтото ми е черно.", "Clothing", "A1"),
  w("clo7", "czapka", "шапка", "cap / hat", "CHAHP-kah", "noun", "f", "czapki", "Zimą noszę czapkę.", "Зимата нося шапка.", "Clothing", "A1"),
  w("clo8", "szalik", "шал", "scarf", "SHAH-leek", "noun", "m", "szaliki", "Babcia zrobiła mi szalik.", "Баба ми изплете шал.", "Clothing", "A1"),
  w("clo9", "rękawiczki", "ръкавици", "gloves", "ren-kah-VEECH-kee", "noun", "—", "—", "Zgubiłem rękawiczki.", "Загубих ръкавиците.", "Clothing", "A2"),
  w("clo10", "bluzka", "блуза", "blouse", "BLOOZ-kah", "noun", "f", "bluzki", "Mam czerwoną bluzkę.", "Имам червена блуза.", "Clothing", "A1"),
  w("clo11", "spódnica", "пола", "skirt", "spood-NEE-tsah", "noun", "f", "spódnice", "Spódnica jest za krótka.", "Полата е твърде къса.", "Clothing", "A1"),
  w("clo12", "skarpetki", "чорапи", "socks", "skar-PET-kee", "noun", "—", "—", "Włóż czyste skarpetki.", "Сложи чисти чорапи.", "Clothing", "A1"),
